export const projects = [
  ...
  {
    title: 'JChef',
    description: "JChef is a comprehensive full stack application that serves as a portable, interactive cookbook and shopping list. JChef was developed in Java and has an android UI.",
