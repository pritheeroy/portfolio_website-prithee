...
const data = [
  { role: 'Software Engineer Intern', employer: 'Manulife', date: 'MAY 2022 - AUG 2022', description: ["Collaborated with a team of quantitative analysts to maintain and support development of quantitative investment strategy system (QISS) in Java (Spring Boot Framework) to support asset management.", "Developed 10+ features for QISS microsite, using Java and React.js, which increased quantitive analyst efficiency by 25%.", "Wrote SQL scripts for data reconciliation project to validate migrated data and created template used by 10+ engineers.", "» Tested 100+ API endpoints using Postman as a part of the annual penetration test.", "» Authored technical documentation to streamline on-boarding process, increasing productivity by 30% on average."]},
  { role: 'IT Automation Developer', employer: 'University of Toronto', date: 'SEPT 2021 - FEB 2022', description: ["Developed Python scripts using Pandas to parse MS Excel sheets and extract data and load it into SharePoint.", " Setup continuous integration using Jenkins and engineered pipelines containing Bash shell scripts to automate infrastructure provisioning.", "Wrote and performed unit and functional tests using Pytest to ensure all data was entered correctly.", "» Updated SharePoint lists to comply with user inputted information from InfoPath forms."]},
  { role: 'IT Project Manager', employer: 'Votorantim Cimentos', date: 'JUL 2021 - SEPT 2021', description: ["Spearheaded a $500k nationwide PC replacement project and expedited the projected completion date by 25%.", "Designed and executed Microsoft Powershell scripts to automate data collection and aggregation.", "Reimaged 100+ PCs and executed Microsoft Powershell scripts to add the PCs to the active directory.", "» Produced reports in Microsoft Power BI to display weekly PC replacement results to 35+ colleagues."]}
];
